...
pub struct SolanaDexPositionProfileMetrics2 {
...
impl SolanaDexPositionProfileMetrics2 {
    pub fn builder() -> SolanaDexPositionProfileMetrics2Builder {
        <SolanaDexPositionProfileMetrics2Builder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct SolanaDexPositionProfileMetrics2Builder {
...
impl SolanaDexPositionProfileMetrics2Builder {
    ...
    /// Consumes the builder and constructs a [`SolanaDexPositionProfileMetrics2`].
    pub fn build(self) -> Result<SolanaDexPositionProfileMetrics2, BuildError> {
        Ok(SolanaDexPositionProfileMetrics2 {
