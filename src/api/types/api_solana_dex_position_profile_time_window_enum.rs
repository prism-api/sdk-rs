...
pub enum SolanaDexPositionProfileTimeWindowEnum {
    Window30D,
    Window14D,
    Window7D,
    Window3D,
...
impl Serialize for SolanaDexPositionProfileTimeWindowEnum {
...
impl<'de> Deserialize<'de> for SolanaDexPositionProfileTimeWindowEnum {
...
impl fmt::Display for SolanaDexPositionProfileTimeWindowEnum {
