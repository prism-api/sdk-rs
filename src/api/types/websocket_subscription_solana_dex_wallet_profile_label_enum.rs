...
pub enum SolanaDexWalletProfileLabelEnum2 {
    Kol,
    Trencher,
    Conviction,
    Smart,
...
impl Serialize for SolanaDexWalletProfileLabelEnum2 {
...
impl<'de> Deserialize<'de> for SolanaDexWalletProfileLabelEnum2 {
...
impl fmt::Display for SolanaDexWalletProfileLabelEnum2 {
