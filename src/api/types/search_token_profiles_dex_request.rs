...
pub struct SearchTokenProfilesDexRequest {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub query: Option<SolanaDexTokenProfileSearchPayloadQueryField>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl SearchTokenProfilesDexRequest {
    pub fn builder() -> SearchTokenProfilesDexRequestBuilder {
        <SearchTokenProfilesDexRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct SearchTokenProfilesDexRequestBuilder {
...
impl SearchTokenProfilesDexRequestBuilder {
    pub fn query(mut self, value: SolanaDexTokenProfileSearchPayloadQueryField) -> Self {
    ...
    /// Consumes the builder and constructs a [`SearchTokenProfilesDexRequest`].
    pub fn build(self) -> Result<SearchTokenProfilesDexRequest, BuildError> {
        Ok(SearchTokenProfilesDexRequest {
            query: self.query,
            filter: self.filter,
            sort: self.sort,
