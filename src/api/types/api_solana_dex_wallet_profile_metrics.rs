...
pub struct SolanaDexWalletProfileMetrics {
...
impl SolanaDexWalletProfileMetrics {
    pub fn builder() -> SolanaDexWalletProfileMetricsBuilder {
        <SolanaDexWalletProfileMetricsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct SolanaDexWalletProfileMetricsBuilder {
...
impl SolanaDexWalletProfileMetricsBuilder {
    ...
    /// Consumes the builder and constructs a [`SolanaDexWalletProfileMetrics`].
    pub fn build(self) -> Result<SolanaDexWalletProfileMetrics, BuildError> {
        Ok(SolanaDexWalletProfileMetrics {
