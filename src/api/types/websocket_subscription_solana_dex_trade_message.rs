...
pub struct SolanaDexTradeMessage {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub direction: Option<SolanaDexTradeDirectionEnum2>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub position_state: Option<SolanaDexTradePositionStateEnum2>,
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(default)]
...
pub struct SolanaDexTradeMessageBuilder {
    ...
    direction: Option<SolanaDexTradeDirectionEnum2>,
    position_state: Option<SolanaDexTradePositionStateEnum2>,
...
impl SolanaDexTradeMessageBuilder {
    ...
    pub fn direction(mut self, value: SolanaDexTradeDirectionEnum2) -> Self {
        self.direction = Some(value);
        self
    }

    pub fn position_state(mut self, value: SolanaDexTradePositionStateEnum2) -> Self {
