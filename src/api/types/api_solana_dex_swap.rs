...
impl SolanaDexSwap {
    pub fn builder() -> SolanaDexSwapBuilder {
        <SolanaDexSwapBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct SolanaDexSwapBuilder {
    id: Option<i64>,
...
impl SolanaDexSwapBuilder {
    ...
    /// Consumes the builder and constructs a [`SolanaDexSwap`].
    pub fn build(self) -> Result<SolanaDexSwap, BuildError> {
        Ok(SolanaDexSwap {
            id: self.id,
