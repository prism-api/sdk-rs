...
pub struct SolanaDexPositionProfileMetrics {
...
impl SolanaDexPositionProfileMetrics {
    pub fn builder() -> SolanaDexPositionProfileMetricsBuilder {
        <SolanaDexPositionProfileMetricsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct SolanaDexPositionProfileMetricsBuilder {
...
impl SolanaDexPositionProfileMetricsBuilder {
    ...
    /// Consumes the builder and constructs a [`SolanaDexPositionProfileMetrics`].
    pub fn build(self) -> Result<SolanaDexPositionProfileMetrics, BuildError> {
        Ok(SolanaDexPositionProfileMetrics {
