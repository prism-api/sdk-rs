...
pub struct SolanaDexTokenProfileMetadata {
...
impl SolanaDexTokenProfileMetadata {
    pub fn builder() -> SolanaDexTokenProfileMetadataBuilder {
        <SolanaDexTokenProfileMetadataBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct SolanaDexTokenProfileMetadataBuilder {
...
impl SolanaDexTokenProfileMetadataBuilder {
    ...
    /// Consumes the builder and constructs a [`SolanaDexTokenProfileMetadata`].
    pub fn build(self) -> Result<SolanaDexTokenProfileMetadata, BuildError> {
        Ok(SolanaDexTokenProfileMetadata {
