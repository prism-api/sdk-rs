...
pub struct SolanaDexTokenProfileMetrics {
...
impl SolanaDexTokenProfileMetrics {
    pub fn builder() -> SolanaDexTokenProfileMetricsBuilder {
        <SolanaDexTokenProfileMetricsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct SolanaDexTokenProfileMetricsBuilder {
...
impl SolanaDexTokenProfileMetricsBuilder {
    ...
    /// Consumes the builder and constructs a [`SolanaDexTokenProfileMetrics`].
    pub fn build(self) -> Result<SolanaDexTokenProfileMetrics, BuildError> {
        Ok(SolanaDexTokenProfileMetrics {
