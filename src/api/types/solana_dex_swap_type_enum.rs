...
pub enum SolanaDexSwapTypeEnum {
    QuoteToken,
    TokenQuote,
    TokenToken,
    QuoteQuote,
...
impl Serialize for SolanaDexSwapTypeEnum {
...
impl<'de> Deserialize<'de> for SolanaDexSwapTypeEnum {
...
impl fmt::Display for SolanaDexSwapTypeEnum {
