...
impl DexClient {
    ...
    pub async fn get_wallet_profile(
        &self,
        request: &GetWalletProfileDexRequest,
        options: Option<RequestOptions>,
    ) -> Result<SolanaDexWalletProfile, ApiError> {
        self.http_client
            .execute_request(
                Method::POST,
    ...
    ///
    /// JSON response from the API
    pub async fn search_wallet_profiles(
        &self,
        request: &SearchWalletProfilesDexRequest,
        options: Option<RequestOptions>,
    ) -> Result<SearchWalletProfilesDexResponse, ApiError> {
        self.http_client
            .execute_request(
                Method::POST,
    ...
    pub async fn get_token_profile(
        &self,
        request: &GetTokenProfileDexRequest,
        options: Option<RequestOptions>,
    ) -> Result<SolanaDexTokenProfile, ApiError> {
        self.http_client
            .execute_request(
                Method::POST,
    ...
    ///
    /// JSON response from the API
    pub async fn search_token_profiles(
        &self,
        request: &SearchTokenProfilesDexRequest,
        options: Option<RequestOptions>,
    ) -> Result<SearchTokenProfilesDexResponse, ApiError> {
        self.http_client
            .execute_request(
                Method::POST,
    ...
    pub async fn get_trades(
        &self,
        request: &GetTradesDexRequest,
        options: Option<RequestOptions>,
    ) -> Result<GetTradesDexResponse, ApiError> {
        self.http_client
            .execute_request(
                Method::POST,
    ...
    pub async fn get_swaps(
        &self,
        request: &GetSwapsDexRequest,
        options: Option<RequestOptions>,
    ) -> Result<GetSwapsDexResponse, ApiError> {
        self.http_client
            .execute_request(
                Method::POST,
    ...
    pub async fn get_price(
        &self,
        request: &GetPriceDexRequest,
        options: Option<RequestOptions>,
    ) -> Result<Vec<SolanaDexPrice>, ApiError> {
        self.http_client
            .execute_request(
                Method::POST,
    ...
    pub async fn get_price_stats(
        &self,
        request: &GetPriceStatsDexRequest,
        options: Option<RequestOptions>,
    ) -> Result<Vec<SolanaDexPriceStats>, ApiError> {
        self.http_client
            .execute_request(
                Method::POST,
    ...
    pub async fn get_price_candles(
        &self,
        request: &GetPriceCandlesDexRequest,
        options: Option<RequestOptions>,
    ) -> Result<Vec<SolanaDexPriceCandle>, ApiError> {
        self.http_client
            .execute_request(
                Method::POST,
    ...
    pub async fn get_price_history(
        &self,
        request: &GetPriceHistoryDexRequest,
        options: Option<RequestOptions>,
    ) -> Result<Vec<SolanaDexPriceHistory>, ApiError> {
        self.http_client
            .execute_request(
                Method::POST,
